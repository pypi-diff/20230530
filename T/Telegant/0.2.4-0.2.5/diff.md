# Comparing `tmp/Telegant-0.2.4.tar.gz` & `tmp/Telegant-0.2.5.tar.gz`
...
### Comparing `Telegant-0.2.4/setup.py` & `Telegant-0.2.5/setup.py`
...
### Comparing `Telegant-0.2.4/telegant/telegant.py` & `Telegant-0.2.5/telegant/telegant.py`
