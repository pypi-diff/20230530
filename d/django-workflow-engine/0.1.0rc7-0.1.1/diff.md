# Comparing `tmp/django_workflow_engine-0.1.0rc7.tar.gz` & `tmp/django_workflow_engine-0.1.1.tar.gz`
...
## Comparing `django_workflow_engine-0.1.0rc7.tar` & `django_workflow_engine-0.1.1.tar`
...
### Comparing `django_workflow_engine-0.1.0rc7/LICENSE` & `django_workflow_engine-0.1.1/LICENSE`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/README.md` & `django_workflow_engine-0.1.1/PKG-INFO`
...
### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/__init__.py` & `django_workflow_engine-0.1.1/django_workflow_engine/__init__.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/dataclass.py` & `django_workflow_engine-0.1.1/django_workflow_engine/dataclass.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/executor.py` & `django_workflow_engine-0.1.1/django_workflow_engine/executor.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/generate_urls.py` & `django_workflow_engine-0.1.1/django_workflow_engine/generate_urls.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/management/commands/cleanup_workflow_engine.py` & `django_workflow_engine-0.1.1/django_workflow_engine/management/commands/cleanup_workflow_engine.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/migrations/0001_initial.py` & `django_workflow_engine-0.1.1/django_workflow_engine/migrations/0001_initial.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/migrations/0004_auto_20211116_0823.py` & `django_workflow_engine-0.1.1/django_workflow_engine/migrations/0004_auto_20211116_0823.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/migrations/0009_rename_taskrecord_taskrecordexecution_and_create_new_taskstatus.py` & `django_workflow_engine-0.1.1/django_workflow_engine/migrations/0009_rename_taskrecord_taskrecordexecution_and_create_new_taskstatus.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/migrations/0010_create_replacement_task_record.py` & `django_workflow_engine-0.1.1/django_workflow_engine/migrations/0010_create_replacement_task_record.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/migrations/0011_migrate_from_taskrecordexecutions.py` & `django_workflow_engine-0.1.1/django_workflow_engine/migrations/0011_migrate_from_taskrecordexecutions.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/migrations/0012_alter_target_unique_together.py` & `django_workflow_engine-0.1.1/django_workflow_engine/migrations/0012_alter_target_unique_together.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/models.py` & `django_workflow_engine-0.1.1/django_workflow_engine/models.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/tasks/email_form.py` & `django_workflow_engine-0.1.1/django_workflow_engine/tasks/email_form.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/tasks/previous_tasks_complete.py` & `django_workflow_engine-0.1.1/django_workflow_engine/tasks/previous_tasks_complete.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/tasks/send_email.py` & `django_workflow_engine-0.1.1/django_workflow_engine/tasks/send_email.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/tasks/task.py` & `django_workflow_engine-0.1.1/django_workflow_engine/tasks/task.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/templates/django_workflow_engine/flow_detail.html` & `django_workflow_engine-0.1.1/django_workflow_engine/templates/django_workflow_engine/flow_detail.html`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/templates/django_workflow_engine/flow_diagram.html` & `django_workflow_engine-0.1.1/django_workflow_engine/templates/django_workflow_engine/flow_diagram.html`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/templates/django_workflow_engine/flow_list.html` & `django_workflow_engine-0.1.1/django_workflow_engine/templates/django_workflow_engine/flow_list.html`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/templates/includes/requirement_summary.html` & `django_workflow_engine-0.1.1/django_workflow_engine/templates/includes/requirement_summary.html`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/tests/factories.py` & `django_workflow_engine-0.1.1/django_workflow_engine/tests/factories.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/tests/tasks.py` & `django_workflow_engine-0.1.1/django_workflow_engine/tests/tasks.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/tests/test_task_info.py` & `django_workflow_engine-0.1.1/django_workflow_engine/tests/test_task_info.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/tests/test_workflows/test_linear_workflow.py` & `django_workflow_engine-0.1.1/django_workflow_engine/tests/test_workflows/test_linear_workflow.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/tests/test_workflows/test_loops.py` & `django_workflow_engine-0.1.1/django_workflow_engine/tests/test_workflows/test_loops.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/tests/test_workflows/test_pause_task.py` & `django_workflow_engine-0.1.1/django_workflow_engine/tests/test_workflows/test_pause_task.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/tests/test_workflows/test_previous_tasks_complete.py` & `django_workflow_engine-0.1.1/django_workflow_engine/tests/test_workflows/test_previous_tasks_complete.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/tests/test_workflows/test_reminder_workflow.py` & `django_workflow_engine-0.1.1/django_workflow_engine/tests/test_workflows/test_reminder_workflow.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/tests/test_workflows/test_split_and_join_workflow.py` & `django_workflow_engine-0.1.1/django_workflow_engine/tests/test_workflows/test_split_and_join_workflow.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/tests/test_workflows/test_split_workflow.py` & `django_workflow_engine-0.1.1/django_workflow_engine/tests/test_workflows/test_split_workflow.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/tests/utils.py` & `django_workflow_engine-0.1.1/django_workflow_engine/tests/utils.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/tests/workflows.py` & `django_workflow_engine-0.1.1/django_workflow_engine/tests/workflows.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/utils.py` & `django_workflow_engine-0.1.1/django_workflow_engine/utils.py`

 * *Files identical despite different names*

### Comparing `django_workflow_engine-0.1.0rc7/django_workflow_engine/views.py` & `django_workflow_engine-0.1.1/django_workflow_engine/views.py`
