# Comparing `tmp/atlantiscore-2.0.0.tar.gz` & `tmp/atlantiscore-2.1.0.tar.gz`
...
## Comparing `atlantiscore-2.0.0.tar` & `atlantiscore-2.1.0.tar`
...
### Comparing `atlantiscore-2.0.0/atlantiscore/__init__.py` & `atlantiscore-2.1.0/atlantiscore/__init__.py`

 * *Files identical despite different names*

### Comparing `atlantiscore-2.0.0/atlantiscore/db/types/evm.py` & `atlantiscore-2.1.0/atlantiscore/db/types/evm.py`

 * *Files identical despite different names*

### Comparing `atlantiscore-2.0.0/atlantiscore/types/evm.py` & `atlantiscore-2.1.0/atlantiscore/types/evm.py`

 * *Files identical despite different names*

### Comparing `atlantiscore-2.0.0/pyproject.toml` & `atlantiscore-2.1.0/pyproject.toml`
...
### Comparing `atlantiscore-2.0.0/tests/test_finder.py` & `atlantiscore-2.1.0/tests/test_finder.py`
