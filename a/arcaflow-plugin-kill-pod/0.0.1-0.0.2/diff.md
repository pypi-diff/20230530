# Comparing `tmp/arcaflow_plugin_kill_pod-0.0.1.tar.gz` & `tmp/arcaflow_plugin_kill_pod-0.0.2.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "arcaflow_plugin_kill_pod-0.0.1.tar", max compression
+gzip compressed data, was "arcaflow_plugin_kill_pod-0.0.2.tar", max compression
```

## Comparing `arcaflow_plugin_kill_pod-0.0.1.tar` & `arcaflow_plugin_kill_pod-0.0.2.tar`

### file list

```diff
@@ -1,9 +1,9 @@
--rw-r--r--   0        0        0     1558 2023-03-16 16:07:00.104462 arcaflow_plugin_kill_pod-0.0.1/Dockerfile
--rw-r--r--   0        0        0    10174 2023-01-25 15:49:28.000000 arcaflow_plugin_kill_pod-0.0.1/LICENSE
--rw-r--r--   0        0        0      673 2023-01-25 15:49:28.000000 arcaflow_plugin_kill_pod-0.0.1/README.md
--rwxr-xr-x   0        0        0     9968 2023-05-08 13:22:47.883454 arcaflow_plugin_kill_pod-0.0.1/arcaflow_plugin_kill_pod.py
--rw-r--r--   0        0        0      105 2023-03-16 16:07:00.105462 arcaflow_plugin_kill_pod-0.0.1/docker-compose.yaml
--rw-r--r--   0        0        0    52658 2023-05-04 14:41:52.873263 arcaflow_plugin_kill_pod-0.0.1/poetry.lock
--rw-r--r--   0        0        0      997 2023-05-08 13:31:28.334995 arcaflow_plugin_kill_pod-0.0.1/pyproject.toml
--rw-r--r--   0        0        0     6495 2023-01-25 15:49:28.000000 arcaflow_plugin_kill_pod-0.0.1/tests/test_arcaflow_plugin_kill_pod.py
--rw-r--r--   0        0        0     1412 1970-01-01 00:00:00.000000 arcaflow_plugin_kill_pod-0.0.1/PKG-INFO
+-rw-r--r--   0        0        0     1558 2023-03-16 16:07:00.104462 arcaflow_plugin_kill_pod-0.0.2/Dockerfile
+-rw-r--r--   0        0        0    10174 2023-01-25 15:49:28.000000 arcaflow_plugin_kill_pod-0.0.2/LICENSE
+-rw-r--r--   0        0        0      673 2023-01-25 15:49:28.000000 arcaflow_plugin_kill_pod-0.0.2/README.md
+-rwxr-xr-x   0        0        0    10298 2023-05-15 14:54:06.528535 arcaflow_plugin_kill_pod-0.0.2/arcaflow_plugin_kill_pod.py
+-rw-r--r--   0        0        0      105 2023-03-16 16:07:00.105462 arcaflow_plugin_kill_pod-0.0.2/docker-compose.yaml
+-rw-r--r--   0        0        0    64735 2023-05-15 14:58:28.447040 arcaflow_plugin_kill_pod-0.0.2/poetry.lock
+-rw-r--r--   0        0        0     1026 2023-05-30 11:18:15.555538 arcaflow_plugin_kill_pod-0.0.2/pyproject.toml
+-rw-r--r--   0        0        0     6495 2023-01-25 15:49:28.000000 arcaflow_plugin_kill_pod-0.0.2/tests/test_arcaflow_plugin_kill_pod.py
+-rw-r--r--   0        0        0     1447 1970-01-01 00:00:00.000000 arcaflow_plugin_kill_pod-0.0.2/PKG-INFO
```

### Comparing `arcaflow_plugin_kill_pod-0.0.1/Dockerfile` & `arcaflow_plugin_kill_pod-0.0.2/Dockerfile`

 * *Files identical despite different names*

### Comparing `arcaflow_plugin_kill_pod-0.0.1/LICENSE` & `arcaflow_plugin_kill_pod-0.0.2/LICENSE`

 * *Files identical despite different names*

### Comparing `arcaflow_plugin_kill_pod-0.0.1/README.md` & `arcaflow_plugin_kill_pod-0.0.2/README.md`

 * *Files identical despite different names*

### Comparing `arcaflow_plugin_kill_pod-0.0.1/arcaflow_plugin_kill_pod.py` & `arcaflow_plugin_kill_pod-0.0.2/arcaflow_plugin_kill_pod.py`
...
### Comparing `arcaflow_plugin_kill_pod-0.0.1/poetry.lock` & `arcaflow_plugin_kill_pod-0.0.2/poetry.lock`
...
+version = "0.10.0"
 ...
 python-versions = ">=3.9"
+files = [
+    {file = "arcaflow_plugin_sdk-0.10.0-py3-none-any.whl", hash = "sha256:b95ecbe14b19465bc6c54cf57460e6fb3a95ca5b6f92291e6183c38d421323bd"},
+    {file = "arcaflow_plugin_sdk-0.10.0.tar.gz", hash = "sha256:bd4a91987a4962cae731dc3d8cd5c67b49b4e1e3c1426bf672e7cbc83a289c90"},
+]
...
+lock-version = "2.0"
 python-versions = "^3.9"
-content-hash = "132e502288ef5c866ecc68ebd23bdaa9399856533ca6675ec15ad76f02ab32b1"
-
-[metadata.files]
-arcaflow-plugin-sdk = [
-    {file = "arcaflow_plugin_sdk-0.9.0-py3-none-any.whl", hash = "sha256:1254df74d59a7d54f7d046a35b6173db56096299dc0acfc9a1432da75ce1da83"},
-    {file = "arcaflow_plugin_sdk-0.9.0.tar.gz", hash = "sha256:21b22b634148e07fcd636a7263b2dc50a92dcbd2cbad7b72b799345b851b9d5c"},
-]
-attrs = [
...
-]
+content-hash = "c08d088e952f917d057eb7ca2362725e50bc9eb33ade26f0cd441b088ac8947e"
```

### Comparing `arcaflow_plugin_kill_pod-0.0.1/pyproject.toml` & `arcaflow_plugin_kill_pod-0.0.2/pyproject.toml`
...
### Comparing `arcaflow_plugin_kill_pod-0.0.1/tests/test_arcaflow_plugin_kill_pod.py` & `arcaflow_plugin_kill_pod-0.0.2/tests/test_arcaflow_plugin_kill_pod.py`

 * *Files identical despite different names*

### Comparing `arcaflow_plugin_kill_pod-0.0.1/PKG-INFO` & `arcaflow_plugin_kill_pod-0.0.2/PKG-INFO`
