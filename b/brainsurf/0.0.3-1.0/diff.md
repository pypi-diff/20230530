# Comparing `tmp/brainsurf-0.0.3.tar.gz` & `tmp/brainsurf-1.0.tar.gz`
...
### Comparing `brainsurf-0.0.3/brainsurf/data/comparative_visualize.py` & `brainsurf-1.0/brainsurf/data/comparative_visualize.py`
