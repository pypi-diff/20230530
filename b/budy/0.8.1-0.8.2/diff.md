# Comparing `tmp/budy-0.8.1.tar.gz` & `tmp/budy-0.8.2.tar.gz`
...
### Comparing `budy-0.8.1/src/budy/models/address.py` & `budy-0.8.2/src/budy/models/address.py`
...
### Comparing `budy-0.8.1/README.md` & `budy-0.8.2/README.md`
