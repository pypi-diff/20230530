# Comparing `tmp/inventree-kom2-1.0.tar.gz` & `tmp/inventree-kom2-1.0a0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "/home/runner/work/inventree-kom2/inventree-kom2/dist/.tmp-_6k84tz2/inventree-kom2-1.0.tar", last modified: Mon May 29 23:00:43 2023, max compression
...
## Comparing `inventree-kom2-1.0.tar` & `inventree-kom2-1.0a0.tar`

### file list

```diff
@@ -1,18 +1,18 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-29 23:00:43.000000 inventree-kom2-1.0/
--rw-r--r--   0 runner    (1001) docker     (123)       34 2023-05-29 23:00:23.000000 inventree-kom2-1.0/MANIFEST.in
--rw-r--r--   0 runner    (1001) docker     (123)     1840 2023-05-29 23:00:43.000000 inventree-kom2-1.0/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      950 2023-05-29 23:00:23.000000 inventree-kom2-1.0/README.md
--rw-r--r--   0 runner    (1001) docker     (123)     1200 2023-05-29 23:00:23.000000 inventree-kom2-1.0/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (123)      143 2023-05-29 23:00:43.000000 inventree-kom2-1.0/setup.cfg
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-29 23:00:43.000000 inventree-kom2-1.0/src/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-29 23:00:43.000000 inventree-kom2-1.0/src/inventree_kom2/
--rw-r--r--   0 runner    (1001) docker     (123)     2395 2023-05-29 23:00:23.000000 inventree-kom2-1.0/src/inventree_kom2/KiCadClasses.py
--rw-r--r--   0 runner    (1001) docker     (123)     3347 2023-05-29 23:00:23.000000 inventree-kom2-1.0/src/inventree_kom2/Kom2Plugin.py
--rw-r--r--   0 runner    (1001) docker     (123)      172 2023-05-29 23:00:23.000000 inventree-kom2-1.0/src/inventree_kom2/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-29 23:00:43.000000 inventree-kom2-1.0/src/inventree_kom2.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     1840 2023-05-29 23:00:43.000000 inventree-kom2-1.0/src/inventree_kom2.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      399 2023-05-29 23:00:43.000000 inventree-kom2-1.0/src/inventree_kom2.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-05-29 23:00:43.000000 inventree-kom2-1.0/src/inventree_kom2.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       63 2023-05-29 23:00:43.000000 inventree-kom2-1.0/src/inventree_kom2.egg-info/entry_points.txt
--rw-r--r--   0 runner    (1001) docker     (123)       31 2023-05-29 23:00:43.000000 inventree-kom2-1.0/src/inventree_kom2.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       15 2023-05-29 23:00:43.000000 inventree-kom2-1.0/src/inventree_kom2.egg-info/top_level.txt
...
### Comparing `inventree-kom2-1.0/PKG-INFO` & `inventree-kom2-1.0a0/PKG-INFO`
...
### Comparing `inventree-kom2-1.0/pyproject.toml` & `inventree-kom2-1.0a0/pyproject.toml`
...
### Comparing `inventree-kom2-1.0/src/inventree_kom2/KiCadClasses.py` & `inventree-kom2-1.0a0/src/inventree_kom2/KiCadClasses.py`

 * *Files identical despite different names*

### Comparing `inventree-kom2-1.0/src/inventree_kom2/Kom2Plugin.py` & `inventree-kom2-1.0a0/src/inventree_kom2/Kom2Plugin.py`
...
### Comparing `inventree-kom2-1.0/src/inventree_kom2.egg-info/PKG-INFO` & `inventree-kom2-1.0a0/src/inventree_kom2.egg-info/PKG-INFO`
