# Comparing `tmp/pycognaize-1.3.9.tar.gz` & `tmp/pycognaize-1.4.2.tar.gz`
...
### Comparing `pycognaize-1.3.9/pycognaize/document/field/__init__.py` & `pycognaize-1.4.2/pycognaize/document/field/__init__.py`
