# Comparing `tmp/salure_helpers_ftp-1.4.0.tar.gz` & `tmp/salure_helpers_ftp-1.5.0.tar.gz`
...
## Comparing `salure_helpers_ftp-1.4.0.tar` & `salure_helpers_ftp-1.5.0.tar`
...
### Comparing `salure_helpers_ftp-1.4.0/salure_helpers/ftp/ftps.py` & `salure_helpers_ftp-1.5.0/salure_helpers/ftp/ftps.py`
...
### Comparing `salure_helpers_ftp-1.4.0/salure_helpers/ftp/sftp.py` & `salure_helpers_ftp-1.5.0/salure_helpers/ftp/sftp.py`
